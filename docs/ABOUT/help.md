...
杰的想法：并不支持英文 因为文章主要使用中文 访问者主要是中国人

my thoughts:为了练习英语水平，我大概会中英文混杂着写，等考完雅思后，更高频率地使用英文习作

## index

最开始打开网站 也就是通过链接 <https://fan-xiaohua.github.io/> 访问时 会先打开 `/docs/index.md` 这时访问者点击左上角按钮展开目录会先看到大的分类
